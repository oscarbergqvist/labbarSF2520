...
xlabel({'$t$ [time]'},...
    ...
    'FontSize',10,...
    'FontName','Times')
print -depsc2 out/part-2-1-x1.eps
figure('name', 'x2')
...
xlabel({'$t$ [time]'},...
    ...
    'FontSize',10,...
    'FontName','Times')
print -depsc2 out/part-2-1-x2.eps
figure('name', 'x3')
...
xlabel({'$t$ [time]'},...
    ...
    'FontSize',10,...
    'FontName','Times')
print -depsc2 out/part-2-1-x3.eps
...
xlabel({'$t$ [T]'},...
    ...
    'FontSize',10,...
    'FontName','Times')
print -depsc2 out/part-2-2-ode23-1e-3.eps
...
xlabel({'$t$ [T]'},...
    ...
    'FontSize',10,...
    'FontName','Times')
print -depsc2 out/part-2-2-ode23s-1e-3.eps
...
legend({'$30^{\circ}$', '$45^{\circ}$', '$60^{\circ}$'},...
    ...
    'FontName','Times',...
    'Location','NorthEast')
print -depsc2 out/part-3-2-k0.02.eps
...
legend({'$30^{\circ}$', '$45^{\circ}$', '$60^{\circ}$'},...
    ...
    'FontName','Times',...
    'Location','NorthEast')
print -depsc2 out/part-3-2-k0.065.eps
